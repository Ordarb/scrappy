...
class CreditCardDefaults(object):
    ...
    """
    def __init__(self):
        self.url = r'https://fred.stlouisfed.org/graph/fredgraph.xls?bgcolor=%23e1e9f0&chart_type=line&drp=0&fo=open%20sans&graph_bgcolor=%23ffffff&height=450&mode=fred&recession_bars=on&txtcolor=%23444444&ts=12&tts=12&width=1318&nt=0&thu=0&trc=0&show_legend=yes&show_axis_titles=yes&show_tooltip=yes&id=DRCCLACBS&scale=left&cosd=1991-01-01&coed=2022-10-01&line_color=%234572a7&link_values=false&line_style=solid&mark_type=none&mw=3&lw=2&ost=-99999&oet=99999&mma=0&fml=a&fq=Quarterly%2C%20End%20of%20Period&fam=avg&fgst=lin&line_index=1&transformation=lin'
    def run(self):
        df = self.load_data()
        return df
    ...
    def load_data(self):
        ...
        #todo: transformation?
        z = -calc_momentum(df.credit_card, windows=[1, 2, 4]) # monthly change
        z = rescale(z, True, 1)
